import Misstraut from "./assets/Misstraut.png"
        ...
        <div className={"popover__container"}>
            <div className={"popover"}>
                ...
                <div className={"content"}>
                    <div className={"left"}>
                        ...
                        <div className={"description"}>
                            <p>Als ihm ein anspruchsvoller neuer Captain vorgesetzt wird, muss ein genialer, aber
                                kindischer
                                Polizist aus Brooklyn wohl oder übel Regeltreue und Teamfähigkeit lernen.</p>
                        </div>
                    </div>
                    <div className={"cast"}>
                        ...
                        <p><span className={"prefix"}>Genres: </span>Romantische Dramen, Spinonage-Action und
                            -Abenteuer, Gesellschaftsdrama</p>
                    </div>
                </div>
                <div className={"episodes"}>
                    <div className={"episodes__header"}>
                        ...
                        <div className={"selection"} onClick={() => setToggle(!isToggled)}>
                            ...
                            <div className={"dropdown"} data-toggled={isToggled}>
                                {seasons.map(season =>
                                    <div className={"season"} onClick={() => setSelectedSeason((season))}>
                    ...
                    {isAlleFolgen ? seasons.map(season => <SeasonComponent season={season} all={isAlleFolgen}/>) : <SeasonComponent season={selectedSeason} all={isAlleFolgen}/>}
                </div>
            </div>
        </div>
    )
...
function EpisodeComponent({episode}: { episode: Episode }) {
    return (
        <div className={"episode"}>
            ...
            <img className={"episode__cover"} src={episode.cover} alt={"Ah"}/>
